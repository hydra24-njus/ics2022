...
def_THelper(main) {
  ...
  def_INSTR_IDTAB("??????? ????? ????? ??? ????? 11100 11", I     , csrs);
  def_INSTR_IDTAB("??????? ????? ????? ??? ????? 00100 11", I     , add_i);
  ...
  def_INSTR_IDTAB("??????? ????? ????? 000 ????? 11001 11", I     , jalr);//和I型指令结构一致
  def_INSTR_IDTAB("??????? ????? ????? ??? ????? 01100 11", R     , add_r);
